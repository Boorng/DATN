...
import styles from "./ListMainConduct.module.scss";
import FindMainConduct from "../FindMainConduct";

const cx = classNames.bind(styles);

function ListMainConduct({ listHomeRoom, getClassHomeRoom }) {
    //#region Paging
    ...
    return (
        <div>
            <FindMainConduct handleSearch={handleSearch} />
            <Table striped hover>
                <thead>
                    <tr>
                            ...
                            <tr key={item.id}>
                                ...
                                <td className={cx("table-document", "button")}>
                                    <Link
                                        ...
                                        to={`/teacher/homeroom-class/conduct/${item.id}/${item.name}/grade/${item.grade}/academicYear/${item.academicYear}`}
                                    >
                                        Xem chi tiết
                                    </Link>
                                </td>
...
export default ListMainConduct;
