...
import styles from "./UpdateLayoutConductTeacher.module.scss";

const cx = classNames.bind(styles);

function UpdateLayoutConductTeacher({ children }) {
    const {
        gradeName,
        className,
        classId,
        ...
        <div className={cx("detail-layout")}>
            <div className={cx("detail-layout-header")}>
                <h2 className={cx("detail-layout-title")}>
                    CẬP NHẬT KẾT QUẢ ĐÁNH GIÁ HẠNH KIỂM CỦA HỌC SINH{" "}
                    {studentName} LỚP {className} NĂM HỌC {academicYear}
                </h2>
...
export default UpdateLayoutConductTeacher;
