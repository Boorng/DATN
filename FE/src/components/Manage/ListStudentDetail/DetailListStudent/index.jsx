          ...
          {listStudentClass.map((sc, index) => {
            return (
              <tr key={sc.id}>
                ...
                <td className={cx("table-document")}>{sc.studentId}</td>
                <td className={cx("table-document")}>{sc.fullName}</td>
                ...
                <td className={cx("list-button")}>
                  <Button
                    variant="info"
                    className={cx("button")}
                    onClick={() => handleClickDetailInfo(sc)}
                  >
                    Xem chi tiết
                  </Button>
                  ...
                  {sc.status === 1 && (
                    <Button
                      variant="success"
                      className={cx("button")}
                      onClick={() => handleConfirmUpdate(sc.id)}
                    >
                      Chuyển lớp
                    </Button>
                  )}
