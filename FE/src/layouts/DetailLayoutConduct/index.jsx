...
import NavSemesterConduct from "../../components/NavSemesterConduct";

import { getSemesterAPI } from "../../services/semesterService";

import styles from "./DetailLayoutConduct.module.scss";

const cx = classNames.bind(styles);

function DetailLayoutConduct({ children }) {
    const {
        gradeName,
        className,
        classId,
...
export default DetailLayoutConduct;
