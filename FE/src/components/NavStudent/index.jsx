        ...
        {data.map((item) => {
          return (
            <div className={cx("nav-student-item")} key={item.id}>
              {item.content ? (
                <div className={cx("nav-student-item-accordion")}>
                  <div
                    className={cx("nav-student-item-accordion-header")}
                  ...
                  {showList.includes(item.id) && (
                    <div className={cx("nav-student-item-accordion-body")}>
                        ...
                        return (
                          <NavLink
                            ...
                            className={cx(
                              ...
                              itemChild.id === checkResult && "active"
                            )}
                            to={itemChild.to}
                            onClick={() => handleCheckResult(itemChild.id)}
                          >
                            {itemChild.name}
                          </NavLink>
                        );
