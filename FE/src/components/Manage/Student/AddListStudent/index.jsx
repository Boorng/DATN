        ...
        <Table striped hover>
          <thead>
            <tr>
              ...
              <th className={cx("table-head")}>Số điện thoại bố</th>
              <th className={cx("table-head")}>Nghề nghiệp bố</th>
              <th className={cx("table-head")}>Tên mẹ</th>
              <th className={cx("table-head")}>Số điện thoại mẹ</th>
          ...
          <tbody>
            {listStudentAdd.map((stu) => {
              return (
                <tr key={stu.id}>
                  <td className={cx("table-document")}>{stu.id}</td>
                  <td className={cx("table-document")}>{stu.fullName}</td>
                  <td className={cx("table-document")}>{stu.age}</td>
                  <td className={cx("table-document")}>{stu.gender}</td>
                  <td className={cx("table-document")}>{stu.ethnic}</td>
                  <td className={cx("table-document")}>{stu.birthDay}</td>
                  <td className={cx("table-document")}>{stu.email}</td>
                  <td className={cx("table-document")}>{stu.address}</td>
                  <td className={cx("table-document")}>{stu.phone}</td>
                  <td className={cx("table-document")}>{stu.fatherName}</td>
                  <td className={cx("table-document")}>{stu.fatherPhone}</td>
                  <td className={cx("table-document")}>{stu.fatherCareer}</td>
                  <td className={cx("table-document")}>{stu.motherName}</td>
                  <td className={cx("table-document")}>{stu.motherPhone}</td>
                  <td className={cx("table-document")}>{stu.motherCareer}</td>
                  <td className={cx("table-document")}>{stu.schoolYear}</td>
                </tr>
              );
            })}
          </tbody>
