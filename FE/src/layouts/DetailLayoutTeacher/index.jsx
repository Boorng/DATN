...
import NavSemesterTeacher from "../../components/NavSemesterTeacher";
import { getSemesterAPI } from "../../services/semesterService";

import styles from "./DetailLayoutTeacher.module.scss";

const cx = classNames.bind(styles);

function DetailLayoutTeacher({ children }) {
    const {
        gradeName,
        className,
        classId,
        ...
        <div className={cx("detail-layout")}>
            <div className={cx("detail-layout-header")}>
                <h2 className={cx("detail-layout-title")}>
                    KẾT QUẢ HỌC TẬP CỦA HỌC SINH {studentName} LỚP {className}{" "}
...
export default DetailLayoutTeacher;
